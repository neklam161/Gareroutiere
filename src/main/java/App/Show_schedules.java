...
public class Show_schedules extends JInternalFrame {
    ...
    public Show_schedules() {
        ...
        try {
            ...
            {
                String temp = ("SELECT * FROM Schedule Order by date_schedule");
                int Numrow = 0;
    ...
    class AbstractTable extends javax.swing.table.AbstractTableModel {
        ...
        private String[] columnNames = {"Schedule", "Route_id", "Date", "Heure",
            "Bus_id", "Driver_id"
        };

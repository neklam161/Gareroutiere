...
public class MDIWindow extends JFrame implements WindowListener {
    ...
    private JLabel welcome,label1;
    public static JDesktopPane desktop;

    private JMenuItem mnuPaymentRpt;
    //Main mnuBuses;
    /*Employee Emp;
    Author aut;
    Schedule Sched;
    ...
    public MDIWindow() {
        ...
        //label1.setText("Gestion de Gare Routiere");
    ...
    protected JMenuBar CreateJMenuBar() {
        ...
        mnuNewuser.setFont(new Font("Arial", Font.PLAIN, 18));
        ...
        mnuPassengers.setFont(new Font("Arial", Font.PLAIN, 18));
       ...
       // mnuProcesses.setForeground((Color.blue));
        ...
        mnuBooking.setFont(new Font("Arial", Font.PLAIN, 18));
        ...
        mnuPayment.setFont(new Font("Arial", Font.PLAIN, 18));
...
//        mnuReports.setFont(new Font("monospaced", Font.PLAIN, 18));
...
//        mnuBusRpt.setFont(new Font("monospaced", Font.PLAIN, 18));
...
//        mnuEmpRpt.setFont(new Font("monospaced", Font.PLAIN, 18));
...
//        mnuSchedRpt.setFont(new Font("monospaced", Font.PLAIN, 18));
...
//        mnuBookRpt.setFont(new Font("Arial", Font.PLAIN, 18));
...
//
//        mnuPaymentRpt = new JMenuItem("Payment Report (Stored Procedure)");
//        mnuPaymentRpt.setForeground(Color.blue);
//        mnuPaymentRpt.setFont(new Font("Arial", Font.PLAIN, 18));
//        mnuPaymentRpt.setMnemonic('P');
//        //mnuPaymentRpt.setIcon(new ImageIcon(ClassLoader.getSystemResource("images/bookreport.png")));
//        mnuPaymentRpt.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, ActionEvent.CTRL_MASK));
//        mnuPaymentRpt.setActionCommand("paymentreport");
//        mnuPaymentRpt.addActionListener(menulistener);
//        
//        mnuReports.add(mnuBusRpt);
//        mnuReports.add(mnuEmpRpt);
//        mnuReports.add(mnuSchedRpt);
//        mnuReports.add(mnuBookRpt);
//        mnuReports.add(mnuPaymentRpt);
    ...
    ActionListener menulistener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (ActCmd.equalsIgnoreCase("calculator")) {
                ...
                desktop.add(frm);
                frm.setVisible(true);
            }else if(ActCmd.equalsIgnoreCase("paymentreport")){
            	PaymentStoredProcedure frm=new PaymentStoredProcedure();
                frm.setVisible(true);
            }
        }
    };
